...
<head>
    ...
    <!--Slide Show Css -->
    <link href="http://localhost/CodeIgniter/assets/ItemSlider/css/main-style_2.css" rel="stylesheet" />
    <!-- custom CSS here -->
        ...
        <div class="content" id="payment">
            ...
            <div id="complete">
             <span class="sub">By selecting this button you agree to the purchase and subsequent payment for this order.</span> 
                <a class="big_button" id="complete" href="http://localhost/CodeIgniter/index.php/Project_tqctrl">Complete Order</a>
