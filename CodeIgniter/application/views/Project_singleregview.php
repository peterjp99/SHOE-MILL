...
<link href="http://localhost/CodeIgniter/assets/css/style.css" rel="stylesheet" type="text/css" media="all" />
...
<script type="text/javascript" src="http://localhost/CodeIgniter/assets/js/easing.js"></script>
   <script type="text/javascript">
    ...
    <!--Slide Show Css -->
    <link href="http://localhost/CodeIgniter/assets/ItemSlider/css/main-style3.css" rel="stylesheet" />
    <!-- custom CSS here -->
    <link href="http://localhost/CodeIgniter/assets/css/style3.css" rel="stylesheet" />		
</head>
<body>
